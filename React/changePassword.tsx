...
export default function ChangePassword() {
  ...
  const changePasswordSchema = Yup.object().shape({
    old_password: Yup.string().min(3, "Minimum 3 symbols").max(50, "Maximum 50 symbols").required("Old Password is required"),
        ...
        <form className="form w-100" onSubmit={formik.handleSubmit} noValidate id="kt_login_signin_form">
          <div className="my-8 row">
              ...
              <div className="mb-5">
                <input
                  ...
                  className={clsx(
                    "form-control ",
                    {
                      "is-invalid": formik.touched.new_password && formik.errors.new_password && formik.values.new_password !== formik.values.password
                    },
                    {
                      "is-valid": formik.touched.new_password && !formik.errors.new_password && formik.values.new_password === formik.values.password
                    }
                  )}
                />
              </div>
            ...
            <div className="row my-10">
              <div className="col-5">
                <button type="submit" id="kt_sign_in_submit" className="btn btn-sm btn-primary " disabled={formik.isSubmitting || !formik.isValid}>
