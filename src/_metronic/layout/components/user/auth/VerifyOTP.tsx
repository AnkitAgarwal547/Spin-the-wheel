...
import {setToken, userLogin, verifyOtp} from '../../../../../app/modules/auth/core/_requests'
...
export default function VerifyOTP() {
  ...
  console.log('🚀 ~ file: VerifyOTP.tsx ~ line 14 ~ VerifyOTP ~ use', location)
        ...
        <div className='col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12'>
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className='form-group mt-15'>
              <div className=' text-center'>
                <h1 className='fw-normal mb-5'>Enter OTP</h1>
              </div>
